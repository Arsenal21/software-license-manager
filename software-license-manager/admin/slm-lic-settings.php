...
function wp_lic_mgr_settings_menu() {
    ...
    echo '<div class="wrap">';
    echo '<h2 class="imgh2"> <img src="'. SLM_ASSETS_URL.'images/slm_logo.svg" alt="slm logo">Software License Manager Settings v' . SLM_VERSION . '</h2>';
                ...
                <table class="form-table">
                    ...
                    <tr valign="top">
                        ...
                        <td><input name="enable_debug" type="checkbox"<?php if ($options['enable_debug'] != '') echo ' checked="checked"'; ?> value="1"/>
                            ...
                            <br />- View debug log file by clicking <a href="<?php echo SLM_URL. '/public/logs/log.txt'; ?>" target="_blank">here</a>..
