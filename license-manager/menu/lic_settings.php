...
function wp_lic_mgr_general_settings()
{
    if (isset($_POST['info_update']))
    {
        ...
        if(is_numeric($_POST["wp_lic_mgr_max_num_domain"]))update_option('wp_lic_mgr_max_num_domain', (string)$_POST["wp_lic_mgr_max_num_domain"]);
...
<!--
checkbox input example; look in estore admin menu (the new wishlist integration checkbox
-->
