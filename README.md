> :warning: **Back on maintenance**: I have released a new version in the dev branch—beta version 6.1.0, featuring a complete rewrite.
...
🔐 SLM Plus - Enhanced Software License Manager for WordPress
